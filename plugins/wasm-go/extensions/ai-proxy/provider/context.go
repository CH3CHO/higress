...
func (c *ContextConfig) GetId() string {
	return c.id
}
...
func (c *ContextConfig) Validate() error {
	if c.id == "" {
		return errors.New("missing id in context config")
	}
	if c.fileUrl == "" {
...
func createContextCache(contextConfig ContextConfig, timeout uint32) *contextCache {
